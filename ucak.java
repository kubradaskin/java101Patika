...
public class ucak {
    public static void main(String[] args) {
        ...
        System.out.print("Mesafeyi Km turunden giriniz: "); int km = s.nextInt();
        System.out.print("Yasinizi giriniz: "); int yas = s.nextInt();
        System.out.print("Yolculuk tipi seciniz (1-Tek Yonlu ucus||2-Gidiş Dönüş): "); int secim = s.nextInt();
